...
interface IInputIncrease extends DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>{
  amount?:number
  onIncrease?:()=>void
  onDecrease?:()=>void

}
export function InputIncrease({amount=0,onIncrease,onDecrease,...rest }:IInputIncrease) {
  return (
    <>
      ...
      <div {...rest} className="relative flex items-center">
        ...
        <input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={amount} required />
        <button 
          type="button" 
          onClick={onIncrease}
          id="increment-button" 
